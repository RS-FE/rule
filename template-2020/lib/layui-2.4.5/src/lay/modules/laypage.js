  ...
  Class.prototype.view = function(){
    ...
    ,views = {
      ...
      ,page: function(){
        ...
        if(config.count < 1){
          //return "";
          //update by hhb@risencn.com 数据量为0是，输出为第一页
          return '<span class="layui-laypage-curr"><em class="layui-laypage-em" '+ (/^#/.test(config.theme) ? 'style="background-color:'+ config.theme +';"' : '') +'></em><em>1</em></span>';
        }
